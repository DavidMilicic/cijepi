        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <p class="py-2">Ime: {{Auth::user()->name}} <a
                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm"
                            href="#editName" rel="modal:open">Promijenite ime</a></p>

                    <p class="py-2">Email: {{Auth::user()->email}}</p>

                    <p class="py-2">Želite promijeniti šifru? <a
                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm"
                            href="#editPassword" rel="modal:open">Promijenite šifru</a></p>
        ...
        <form action="/promijeniime" id="formime" method="post">
            ...
            <div class="mb-4">
                <input required type="text" name="name"
                    ...
                    id="username" type="text" placeholder="Upišite novo ime...">
            </div>
            <a class="hover:bg-blue-400 py-2 px-4 rounded" href="#" rel="modal:close">Close</a>
            <button form="formime"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm">Promijeni
                ime</button>
        </form>
    </div>
        ...
        <form action="/promijenisifru" id="formsifra" method="post">
            ...
            <div class="mb-4">
                <input required minlength="8" type="password" name="password"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="password" type="text" placeholder="Upišite novu šifru...">
            </div>
            <a class="hover:bg-blue-400 py-2 px-4 rounded" href="#" rel="modal:close">Close</a>
            <button type="submit" form="formsifra"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm">Promijeni
                šifru</button>
        </form>
    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div>
                        ...
                        $conn->close();
                        @endphp
                        @if (\Session::has('successDocDelTermin'))
                        <div
                            class="alert bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative text-center">
                            <ul>
                                <li>{!! \Session::get('successDocDelTermin') !!}</li>
                            </ul>
                        </div>
                        @endif
                    </div>
